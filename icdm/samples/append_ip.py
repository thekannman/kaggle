...
train = pd.read_csv(r'datasets/train_normalized.csv', header=0).values
test = pd.read_csv(r'datasets/test_normalized.csv', header=0).values
cookie = pd.read_csv(r'datasets/cookie_normalized.csv', header=0).values

device_ip_path = "datasets/device_ip.csv"
cookie_ip_path = "datasets/cookie_ip.csv"
...
train_output = open("datasets/train_ip_normalized.csv", "wb")
test_output = open("datasets/test_ip_normalized.csv", "wb")
cookie_output = open("datasets/cookie_ip_normalized.csv", "wb")
